<template>
  <div>
    <el-upload action="#" list-type="picture-card" :limit='4' :before-upload="beforeAvatarUpload" :on-exceed="overflod"
      :file-list="imglist" :http-request="uploadToCos" :before-remove="handleRemove" style="display: flex;">
    ...
    methods: {
      ...
      beforeAvatarUpload(file) {
        ...
        const isSize = new Promise(function(resolve, reject) {
          ...
          this.imglist.push('1') //移除已上传的图片0
          this.newList.push('1')
          this.$message.error('上传图片尺寸为1200*2600');
